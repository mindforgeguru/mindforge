...
class _AnalysisTabState extends ConsumerState<_AnalysisTab> {
  ...
  Widget build(BuildContext context) {
    final gradesAsync = _subject == null
        ? null
        : (_testType == 'online'
            ? ref.watch(parentChildOnlineGradesProvider(_subject))
            : ref.watch(parentChildOfflineGradesProvider(_subject)));
              ...
              child: const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 12),
                    Text('Select a subject to see progress',
                        style: TextStyle(
                            fontSize: 14,
                            color: AppColors.textSecondary)),
                  ],
                ...
                titlesData: FlTitlesData(
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      showTitles: true,
                      interval: math.max(
                          1, (grades.length / 5).ceilToDouble()),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text(value,
            style: TextStyle(
                fontSize: R.fs(context, 20, min: 16, max: 24), fontWeight: FontWeight.bold, color: color)),
        const SizedBox(height: 2),
        Text(label,
            style: TextStyle(
                fontSize: R.fs(context, 11, min: 10, max: 13), color: AppColors.textSecondary)),
      ],
    );
  }
}
          ...
          child: gradesAsync.when(
            ...
            data: (grades) {
              ...
              for (final g in grades) {
                subjectPcts.putIfAbsent(g.subject, () => []).add(g.percentage);
              }
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        color: _pctColor, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
            ],
