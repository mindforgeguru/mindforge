...
class _StudentHomeworkScreenState
    extends ConsumerState<StudentHomeworkScreen>
        ...
        body: TabBarView(
          ...
          children: [
            _HomeworkList(
              ...
              onRefresh: () =>
                  ref.refresh(studentHomeworkProvider.future),
            ),
            _AnnouncementsList(
              asyncProvider: studentBroadcastsProvider,
              onRefresh: () =>
                  ref.refresh(studentBroadcastsProvider.future),
            ),
          ],
        ),
      );
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: _s(context, 8, min: 6, max: 12)),
            // Footer — wrap so it never overflows on narrow screens
            Wrap(
