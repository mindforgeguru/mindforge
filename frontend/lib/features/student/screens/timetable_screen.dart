...
class _StudentTimetableScreenState
  ...
  Widget build(BuildContext context) {
    ...
    // Web: drop into the same single-column layout the dashboard uses —
    // StudentScaffold centres the body in a 600 px column with empty space on
    // either side. Wide two-column layout + the decorative right panel were
    // retired so all student screens look visually consistent.
