...
class StudentFacultyScreen extends ConsumerWidget {
  const StudentFacultyScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return StudentScaffold(
      ...
      body: facultyAsync.when(
        ...
        error: (e, _) => ErrorView(
          error: e,
          onRetry: () => ref.invalidate(facultyProvider),
        ),
        data: (faculty) {
          if (faculty.isEmpty) {
            return Center(
          ...
          return RefreshIndicator(
            onRefresh: () => ref.refresh(facultyProvider.future),
            child: isWide
