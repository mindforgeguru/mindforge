class TestModel {
  ...
  final bool isGraded;
  // True for quizzes auto-created when a teacher logs a taught period.
  final bool autoGenerated;
  // 'ready' | 'generating' | 'failed' — drives the Tests-tab progress UI for
  // auto-quizzes. Manual tests are always 'ready'.
  final String generationStatus;
  // Human-readable reason shown on the failed-quiz card. Null unless failed.
  ...
  /// Auto-quiz still being built by the AI pipeline.
  bool get isGenerating => generationStatus == 'generating';

  /// Auto-quiz that couldn't be generated (thin source / AI failure).
  bool get generationFailed => generationStatus == 'failed';
  ...
  factory TestModel.fromJson(Map<String, dynamic> json) => TestModel(
        ...
        generationStatus: json['generation_status'] as String? ?? 'ready',
